...
public class CustomerTest {
	...
	@Before
	public void setUp() {
		customer = new Customer(1L, "Leighton", "Manning");
		other = new Customer(1L, "Leighton", "Manning");
	}
	...
	public void createCustomerWithId() {
		...
		assertEquals("Leighton", customer.getFirstName());
		assertEquals("Manning", customer.getSurname());
	}
	...
	public void toStringTest() {
		String toString = "id:1 first name:Leighton surname:Manning";
